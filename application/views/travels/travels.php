<div class="site-blocks-cover inner-page-cover" style="background-image: url(<?= base_url() ?>public/images/<?= $staticImages['TRAVELS'][0]->getContent() ?>);" data-aos="fade" data-stellar-background-ratio="0.5">
  <div class="container">
    <div class="row align-items-center justify-content-center text-center">
      <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
        <h1 class="text-white font-weight-light"><?= $infos['TRAVELS'][0]->getContent() ?></h1>
      </div>
    </div>
  </div>
</div>  
