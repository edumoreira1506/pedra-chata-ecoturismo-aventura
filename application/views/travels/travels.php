        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6 mb-5">
              <img src="<?= base_url() . 'public/images/testimonies/' . $testimony->getImagePath() ?>" alt="Image" class="img-md-fluid">
            </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12 mb-5">
              <img src="<?= base_url().'public/images/images-travel/'.$image->getImagePath() ?>" alt="Image" class="img-md-fluid">
            </div>
          </div>
        </div>
      </div>
